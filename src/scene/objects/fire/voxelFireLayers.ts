...
/**
 * The GPU side of the voxel fire: two additive instanced layers shared by every
 * fire on screen. Two draw calls total, no matter how many fires burn.
 *
...
export class VoxelFireLayers {
  ...
  write(emitter: VoxelFireEmitter, origin: WorldPoint, worldScale: number): void {
