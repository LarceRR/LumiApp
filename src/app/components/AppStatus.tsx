...
import type { AppStatusValue } from '../status/appStatusStore';
import { useAppStatusLifecycle } from '../status/useAppStatusLifecycle';
const AnimatedGradient = Animated.createAnimatedComponent(LinearGradient);
type AppStatusProps = { readonly status: AppStatusValue | null };
export function AppStatus({ status: source }: AppStatusProps): ReactElement | null {
  const status = useAppStatusLifecycle(source);
